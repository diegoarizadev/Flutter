...
void main() {
  ...
  final rawJson =
      '{"nombre": "Superman", "poder":"Fuerza"}'; //Simulación de un Json "Respuesta de un servicio.."

  final parsedJson =
      json.decode(rawJson); //retorna un objeto de tipo map, dinamic.
  print(parsedJson);
...
class Heroe {
  ...
  Heroe({nombre, poder}); //Argumentos con nombre posicionales
